...
@ControllerAdvice
public class TaskInterceptorError extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> taskHandlerException(TaskManagerException ex, WebRequest request) {
        Map<String, String> errors = new HashMap<>();
